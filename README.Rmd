...
This function takes 2 parameters, a path to an empty folder where the RDS files are stored and the number of cores.
When the folder does not exists, it will be created.
The folder needs to be empty, otherwise the function throws an error.
Either remove all files in the folder or enter a different, empty, folder.
